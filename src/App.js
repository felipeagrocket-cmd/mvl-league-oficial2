    ...
    <div className="w-full bg-black border-b border-slate-800 flex items-center justify-center overflow-hidden py-3.5 px-4 relative z-20 shadow-[0_10px_30px_rgba(0,0,0,0.5)]">
      <style>{`
        ...
        .typing-cursor {
          ...
          width: 6px;
          height: 18px;
          background-color: #f59e0b; /* Dourado/Amber elegante */
      ...
      <div className="max-w-full overflow-x-auto hide-scroll text-center flex justify-center w-full">
        <div
          key={key}
          className="animate-typewriter text-[10px] md:text-xs uppercase tracking-[0.15em] font-black items-center"
        >
          {/* Botão de Ao Vivo */}
          <span className="relative flex h-2 w-2 md:h-2.5 md:w-2.5 mr-3">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-red-500 opacity-75"></span>
            <span className="relative inline-flex rounded-full h-2 w-2 md:h-2.5 md:w-2.5 bg-red-600"></span>
          </span>

          {/* Prefixo (Cinza elegante, sem roubar a cena) */}
          <span className="text-slate-400 font-semibold">
            {currentStat.prefix}
          </span>

          {/* NOME EM BRANCO SÓLIDO (Limpo e de leitura imediata) */}
          <span className="text-white text-sm md:text-base mx-2 font-black">
            {currentStat.name}
          </span>

          {/* VALOR EM DOURADO (Destacando o número/resultado) */}
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-end gap-6">
          <div>
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tight mb-2 flex items-center gap-4">
              <ShoppingCart className="text-blue-400" size={40} /> Mercado
            </h2>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        {showBanModal && selectedPlayerToBan && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 animate-fadeIn">
            <div className="bg-slate-950 border border-red-900/50 rounded-3xl w-full max-w-md h-fit my-auto max-h-[90vh] shadow-[0_0_60px_rgba(220,38,38,0.2)] relative overflow-y-auto flex flex-col text-left">
        ...
        {showUnbanModal && selectedBanToRevoke && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/90 backdrop-blur-sm p-4 animate-fadeIn">
            <div className="bg-slate-950 border border-emerald-900/50 rounded-3xl w-full max-w-md h-fit my-auto max-h-[90vh] shadow-[0_0_60px_rgba(16,185,129,0.15)] relative overflow-y-auto flex flex-col text-left">
              ...
              <div className="p-6 md:p-8 space-y-6 bg-slate-900 text-center">
                ...
                <div className="text-slate-500 text-xs bg-slate-950 p-3 rounded-lg border border-slate-800">
                  Ele voltará como <strong>Agente Livre</strong>. Contratos
                  passados com clãs não serão reativados.
                </div>
                <button
...
const StartHerePage = ({ data, onPlayerClick }) => {
  ...
  return (
    <div className="animate-fadeIn space-y-16 pb-16">
      {/* 1. CABEÇALHO E TOGGLE (O PRIMEIRO IMPACTO) */}
      <div className="relative text-center max-w-4xl mx-auto space-y-6 pt-8">
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center justify-center gap-3 mt-10 bg-slate-900/60 p-2.5 rounded-2xl border border-slate-800 w-fit mx-auto shadow-inner backdrop-blur-sm">
          ...
          >
            <span className="text-lg">🛡️</span> Quero montar um Clã
          </button>
        </div>
      </div>
      ...
      <div className="bg-gradient-to-br from-slate-900 to-slate-950 p-8 md:p-12 rounded-3xl border border-slate-800 shadow-2xl relative z-10 overflow-hidden mt-16 max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <div className="flex flex-col items-center text-center">
            <div className="w-12 h-12 bg-slate-800 rounded-full flex items-center justify-center text-white mb-4 shadow-inner">
              <Activity size={24} />
            </div>
            <h5 className="text-white font-bold uppercase text-sm mb-2">
              100% Automático
            </h5>
            <p className="text-slate-500 text-xs leading-relaxed">
              Acabou a partida? Pronto. O sistema já calculou o XP, pagou o
              salário e atualizou o ranking sozinho.
            </p>
          </div>
          <div className="flex flex-col items-center text-center">
            <div className="w-12 h-12 bg-slate-800 rounded-full flex items-center justify-center text-white mb-4 shadow-inner">
            ...
            <p className="text-slate-500 text-xs leading-relaxed">
              Quer jogar hoje mas seu clã não está online? Entre no MIX. O
              sistema sorteia as equipes baseadas no K/D, garantindo jogos
              equilibrados.
            </p>
          </div>
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-slate-500 text-xs leading-relaxed">
              Sem aplicativos pesados. Acesse o mercado, veja os contratos e o
              ranking direto do navegador do seu celular.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="pt-16 pb-8 border-t border-slate-800/80 overflow-hidden relative">
        ...
        {/* Máscara de degrade nas bordas para o carrossel sumir suavemente */}
        <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-slate-950 to-transparent z-20 pointer-events-none mt-20"></div>
        <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-slate-950 to-transparent z-20 pointer-events-none mt-20"></div>
        ...
        <style>{`
          ...
          .animate-carousel {
            display: flex;
            width: calc(180px * ${carouselPlayers.length});
        ...
        <div className="overflow-hidden w-full relative z-10">
          <div className="animate-carousel gap-4 px-4">
            {carouselPlayers.map((p, idx) => (
              <div
                key={`${p.id}-${idx}`}
                onClick={() => onPlayerClick(p.id)}
                className="w-[160px] shrink-0 cursor-pointer group"
              >
                <div className="w-full aspect-[4/3] rounded-xl overflow-hidden bg-slate-900 border border-slate-800 mb-3 shadow-md group-hover:border-slate-600 transition-colors">
                  <img
                    src={p.avatarUrl}
                    alt={p.nickname}
                ...
                <div className="text-center">
                  <span className="text-white font-bold text-sm truncate block group-hover:text-amber-400 transition-colors">
                    {p.nickname}
                  </span>
                </div>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-10 relative z-10">
                    ...
                    >
                      ...
                      <button
                        onClick={() => {
                          ...
                          setProposalTransferOffer(baseValue + penalty);
                          setProposalBonus("");
                          setProposalPitch("");
                        }}
        ...
        {proposalModalPlayer &&
          (() => {
            ...
            const baseValue = p.marketValue || 10000000;
            const penaltyValue = hasReleaseClause
              ? calculateReleaseClause(baseValue, p.releaseClauseMultiplier)
              : 0;
            const minOffer = baseValue + penaltyValue;
                ...
                <div className="bg-slate-900 border border-slate-700 rounded-3xl w-full max-w-lg shadow-2xl relative overflow-hidden flex flex-col max-h-[90vh]">
                  <div className="bg-slate-950 p-6 border-b border-slate-800 flex justify-between items-center shrink-0">
                    <h3 className="text-white font-black uppercase flex items-center gap-2 text-lg tracking-tight">
                      ...
                      {hasReleaseClause ? "Compra Hostil" : "Nova Oferta"}
                    </h3>
                    <button
                  ...
                  <div className="p-6 md:p-8 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-800">
                    ...
                    <div className="space-y-6">
                      {/* AVISO DE MULTA RESCISÓRIA EM COMPRA HOSTIL */}
                      {hasReleaseClause && (
                        <div className="bg-red-500/10 border border-red-500/30 p-4 rounded-xl flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <div className="text-red-300/80 text-[10px] leading-relaxed">
                              A Multa Rescisória de{" "}
                              <strong>{formatCurrency(penaltyValue)}</strong> já
                              foi embutida no valor mínimo da oferta. Ao enviar
                              a proposta, isso configura uma{" "}
                              <strong>Compra Hostil</strong>.
                            </div>
                          </div>
                        </div>
                      )}
                      ...
                      <div>
                        <label className="flex justify-between items-end mb-2">
                          ...
                          <span className="text-[9px] text-slate-500 font-mono">
                            Min: {formatCurrency(minOffer)}
                          </span>
                        </label>
                        <input
                          type="number"
                          min={minOffer}
                          className={`w-full bg-slate-950 border rounded-xl p-4 text-white text-lg outline-none transition-colors shadow-inner font-mono font-black ${
                            hasReleaseClause
                      ...
                      <button
                        disabled={isBankrupting || currentOffer < minOffer}
                        onClick={async () => {
                          const propId = await onCreateProposal(
                            p.id,
                            clan.id,
                      ...
                      >
                        {isBankrupting ? (
                          ...
                          <>
                            <Check size={18} /> Gerar e Copiar Link Secreto
                          </>
                        )}
                      </button>
                    </div>
